...
<template>
  <ion-button color="primary" type="submit" :form="TRAINING_EXERCISE_FORM_ID">Create</ion-button>
...
import { TRAINING_EXERCISE_FORM_ID, useTrainingStore } from '~/entities/training';
